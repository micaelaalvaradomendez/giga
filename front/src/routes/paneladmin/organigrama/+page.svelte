<script>
  ...
  function openEditModal(node) {
    ...
    formData = {
      ...
      titular_id: node.jefe?.id_agente ?? node.titular_id ?? null,
  ...
  async function handleDelete() {
    if (nodeToDelete) {
      if (Array.isArray(organigramaData.organigrama)) {
        ...
        organigramaData.organigrama = organigramaData.organigrama.filter(
        ...
        try {
          ...
          if (importedData.organigrama) {
            ...
            if (saved) {
              organigramaData = { ...organigramaData }; // Trigger reactivity
              await showAlert(
                "✅ Organigrama importado exitosamente",
                "success",
                "Éxito",
              );
            }
  ...
  <div class="admin-header">
    ...
    {#if showUnsavedWarning}
      <div class="unsaved-warning">
        ⚠️ <strong>Hay cambios sin guardar</strong> - Haga clic en "💾 Guardar Cambios"
      ...
      <form on:submit|preventDefault={handleSubmit}>
        <div class="modal-body">
          {#if showParentSelector}
            <div class="form-group">
              ...
              <small class="form-help">
                Seleccione dónde agregar el nuevo. Si no selecciona nada, será
                una raíz.
              </small>
            </div>
          ...
          <div class="form-group">
            ...
            <select
              id="titular"
              bind:value={formData.titular_id}
              on:change={(e) => {
